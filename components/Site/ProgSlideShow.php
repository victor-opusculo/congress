...
class ProgSlideShow extends Component
{
    ...
    protected function markup() : Component
    {
        ...
        [
            ...
            View::tag('button', type: 'button', class: 'prevSlideButton text-[5rem] absolute flex items-end ml-4 cursor-pointer hover:text-neutral-300 left-0 top-0 bottom-0 text-white font-bold', children: [ View::text('⇦') ]),
            View::tag('button', type: 'button', class: 'nextSlideButton text-[5rem] absolute flex items-end mr-4 cursor-pointer hover:text-neutral-300 right-0 top-0 bottom-0 text-white font-bold -scale-x-100', children: [ View::text('⇦') ]),
        ]);
    }
}