...
final class NotificationToUploadIddedArticle
{
    public static function send(Article $article, Submitter $submitter)
    {
        ...
        $mail->Subject  = System::eventName() . " - Seu artigo foi aprovado!"; // Assunto da mensagem

        ob_start();
        $__VIEW = 'notificationToUploadIddedArticle.php';
