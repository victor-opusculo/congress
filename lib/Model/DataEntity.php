...
{	
	...
	public function getSingle(mysqli $conn) : static
	{
		...
		if (isset($dataRow)) 
			...
			throw new \Congress\Lib\Model\Exceptions\DatabaseEntityNotFound('Dados não localizados!', $this->databaseTable);
	}
	...
	{		
		...
		catch (\Congress\Lib\Model\Exceptions\DatabaseEntityNotFound $e)
		{
			$isUpdate = false;
		}
