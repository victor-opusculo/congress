            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        View::tag('li', children: [ View::text('O manuscrito deverá ser submetido sem identificação dos autores (conforme modelo do template). Atentar para que nenhuma forma de identificação automática deve ser percebida, sob o risco de eliminação da submissão. Caso seja aprovado, será solicitado o reenvio com a identificação;') ]),
